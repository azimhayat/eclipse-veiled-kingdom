  ...
  return {
    ...
    objective: {
      ...
      phaseHints: {
        ...
        duel: 'THE SEVERED COURT · move, guard, interrupt, and chain STRIKE like a true duel',
        finale: 'DAWNSTROKE · step close and free the defeated guardian',
