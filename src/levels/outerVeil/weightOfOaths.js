  ...
  return {
    ...
    objective: {
      ...
      phaseHints: {
        ...
        cross: 'KEEP IT BOUND · hold JUMP from the cyan block to the archive ledge',
        carve: 'FACE RIGHT INTO THE CYAN RECORD · press K / SHIFT or DIG',
        seal: 'DROP TO THE ROAD · stand beside the block and DIG to release · push east and bind again',
