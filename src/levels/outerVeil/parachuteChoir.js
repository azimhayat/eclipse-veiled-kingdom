  ...
  return {
    ...
    objective: {
      ...
      formations: {
        ...
        updraft: [
          { shipId: 'low-cantor', tx: 73, ty: 7.5 },
          { shipId: 'high-cantor', tx: 79, ty: 4.6 },
          { shipId: 'far-cantor', tx: 84, ty: 7.3 },
        ],
        complete: [
      ...
      windLoom: {
        ...
        liftSeconds: 1.15,
        state: 'warning',
        launch: { minTx: 76, maxTx: 82, feetTy: 22 },
        ring: { tx: 79, ty: 16.5, radius: 1.4 * TILE },
        launched: false,
        crossed: false,
        attempts: 0,
      },
